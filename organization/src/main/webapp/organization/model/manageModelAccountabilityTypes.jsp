...
<fr:edit id="organizationalModel" name="organizationalModel" schema="module.organization.domain.OrganizationalModel.accountabilityTypes"
	action="<%= url %>">
	<fr:layout name="tabular">
		<fr:property name="classes" value="listInsideClear tdleft" />
