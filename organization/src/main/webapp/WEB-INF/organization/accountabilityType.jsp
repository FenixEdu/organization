...
<script type="text/javascript">
    ...
    var partyType = <%= request.getAttribute("accountabilityType")%>;
    ...
    document.getElementById("deleteForm").action = contextPath + '/organization/accountabilityType/' + partyType.id + "/delete";
