...
<fr:edit action="/contacts.do?method=setVisibilityGroups" id="visibilityGroupsConcededBean" name="visibilityGroupsConcededBean" schema="pt.ist.bennu.core.modules.contacts.ListVisibilityGroups">
		<fr:layout name="tabular">
