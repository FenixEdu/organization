...
public class Planet extends Place<Place<?, Planet>, Country> {
    ...
    private void loadCountryData() {
        final Planet planet = this;
        FileUtil.consumeResourceByLines(RESOURCE_PATH + "countries.txt", new Consumer<String>() {
            @Override
    ...
    private void loadDistricts(final Country country, final String resourcePrefix) {
        FileUtil.consumeResourceByLines(resourcePrefix + "/districts.txt", new Consumer<String>() {
            @Override
            public void accept(final String line) {
    ...
    private void loadMunicipalities(final Country country, final String resourcePrefix) {
        FileUtil.consumeResourceByLines(resourcePrefix + "/municipalities.txt", new Consumer<String>() {
            @Override
            public void accept(final String line) {
    ...
    private void loadPostalCodes(final Country country, final String resourcePrefix) {
        FileUtil.consumeResourceByLines(resourcePrefix + "/postalCodes.txt", new Consumer<String>() {
            @Override
            public void accept(final String line) {
                final int s1 = line.indexOf(';');
                final int s2 = line.indexOf(';', s1 + 1);
    ...
    private void loadParishes(final Country country, final String resourcePrefix) {
        FileUtil.consumeResourceByLines(resourcePrefix + "/parishes.txt", new Consumer<String>() {
            @Override
            public void accept(final String line) {
                final int s1 = line.indexOf(';');
                final int s2 = line.indexOf(';', s1 + 1);
    ...
    public static Parish importParishFromString(final String string) {
        return string == null || string.length() == 0 ? null : Parish.importParishFromString(string);
    }
